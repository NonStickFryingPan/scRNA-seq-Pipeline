...
> **Note on Scale:** While the reference tutorial used 8,785 cells, this exploration focused on a subsampled 252-cell set, requiring more permissive QC thresholds to maintain statistical power.
